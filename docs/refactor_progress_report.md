...
> [简述功能]
  ...
  - [x] `queryGroupBlockedUserIds(@NotNull Long groupId)` -> [QueryGroupBlockedUserIds(ctx context.Context, groupID int64)](../internal/domain/group/service/group_blocklist_service.go#L219)
  ...
  - [x] `queryGroupBlockedUserIdsWithVersion(@NotNull Long groupId, @Nullable Date lastUpdatedDate)` -> [QueryGroupBlockedUserIdsWithVersion(ctx context.Context, groupID int64, lastUpdatedDate *time.Time)](../internal/domain/group/service/group_blocklist_service.go#L233)
  - [x] `queryGroupBlockedUserInfosWithVersion(@NotNull Long groupId, @Nullable Date lastUpdatedDate)` -> [QueryGroupBlockedUserInfosWithVersion(ctx context.Context, groupID int64, lastUpdatedDate *time.Time)](../internal/domain/group/service/group_blocklist_service.go#L257)
  - [x] `addBlockedUser(@NotNull Long groupId, @NotNull Long userId, @NotNull Long requesterId, @Nullable @PastOrPresent Date blockDate)` -> [AddBlockedUser(ctx context.Context, groupID int64, userID int64, requesterID int64, blockDate *time.Time)](../internal/domain/group/service/group_blocklist_service.go#L281)
  ...
  - [x] `deleteBlockedUsers(@NotEmpty Set<GroupBlockedUser.@ValidGroupBlockedUserKey Key> keys)` -> [DeleteBlockedUsers(ctx context.Context, keys []po.GroupBlockedUserKey)](../internal/domain/group/service/group_blocklist_service.go#L308)
...
> [简述功能]
  ...
  - [x] `authAndCreateGroupJoinRequest(@NotNull Long requesterId, @NotNull Long groupId, @Nullable String content)` -> [AuthAndCreateJoinRequest(ctx context.Context, requesterID int64, groupID int64, content string)](../internal/domain/group/service/group_join_request_service.go#L46)
  - [x] `authAndRecallPendingGroupJoinRequest(@NotNull Long requesterId, @NotNull Long requestId)` -> [AuthAndRecallPendingJoinRequest(ctx context.Context, requesterID int64, requestID int64)](../internal/domain/group/service/group_join_request_service.go#L108)
  ...
  - [x] `queryGroupJoinRequestsByGroupId(@NotNull Long groupId)` -> [QueryGroupJoinRequestsByGroupId(ctx context.Context, groupID int64)](../internal/domain/group/service/group_join_request_service.go#L233)
  - [x] `queryGroupJoinRequestsByRequesterId(@NotNull Long requesterId)` -> [QueryGroupJoinRequestsByRequesterId(ctx context.Context, requesterID int64)](../internal/domain/group/service/group_join_request_service.go#L237)
  - [x] `queryGroupId(@NotNull Long requestId)` -> [QueryGroupId(ctx context.Context, requestID int64)](../internal/domain/group/service/group_join_request_service.go#L241)
  ...
  - [x] `deleteJoinRequests(@Nullable Set<Long> ids)` -> [DeleteJoinRequests(ctx context.Context, ids []int64)](../internal/domain/group/service/group_join_request_service.go#L249)
  ...
  - [x] `createGroupJoinRequest(@Nullable Long id, @NotNull Long groupId, @NotNull Long requesterId, @NotNull Long responderId, @Nullable String content, @Nullable @ValidRequestStatus RequestStatus status, @Nullable @PastOrPresent Date creationDate, @Nullable @PastOrPresent Date responseDate, @Nullable String responseReason)` ➡️ [`internal/domain/group/service/group_join_request_service.go`](../internal/domain/group/service/group_join_request_service.go)
...
> [简述功能]
  ...
  - [x] `findExistentMemberGroupIds(@NotEmpty Set<Long> groupIds, @NotNull Long userId)` -> [FindExistentMemberGroupIds(ctx context.Context, groupIDs []int64, userID int64)](../internal/domain/group/service/group_member_service.go#L147)
  ...
  - [x] `queryGroupMemberKeyAndRolePairs(@NotNull Set<Long> userIds, @NotNull Long groupId)` -> [FindGroupMemberKeyAndRolePairs(ctx context.Context, groupID int64, userIDs []int64)](../internal/domain/group/repository/group_member_repository.go#L216)
  ...
  - [x] `queryUserJoinedGroupIds(@NotNull Long userId)` -> [QueryUserJoinedGroupIds(ctx context.Context, userID int64)](../internal/domain/group/service/group_member_service.go#L615)
  - [x] `queryUsersJoinedGroupIds(@Nullable Set<Long> groupIds, @NotEmpty Set<Long> userIds, @Nullable Integer page, @Nullable Integer size)` -> [QueryUsersJoinedGroupIds(ctx context.Context, groupIDs []int64, userIDs []int64, page, size *int)](../internal/domain/group/service/group_member_service.go#L621)
  - [x] `queryMemberIdsInUsersJoinedGroups(@NotEmpty Set<Long> userIds, boolean preferCache)` -> [QueryMemberIdsInUsersJoinedGroups(ctx context.Context, userIDs []int64)](../internal/domain/group/service/group_member_service.go#L627)
  - [x] `queryGroupMemberIds(@NotNull Long groupId, boolean preferCache)` -> [FindGroupMemberIDs(ctx context.Context, groupID int64)](../internal/domain/group/repository/group_member_repository.go#L73)
  - [x] `queryGroupMemberIds(@NotEmpty Set<Long> groupIds, boolean preferCache)` -> [QueryGroupMemberIds(ctx context.Context, groupIDs []int64)](../internal/domain/group/service/group_member_service.go#L640)
  ...
  - [x] `authAndQueryGroupMembersWithVersion(@NotNull Long requesterId, @NotNull Long groupId, @Nullable Date lastUpdatedDate, boolean withStatus)` -> [AuthAndQueryGroupMembersWithVersion(ctx context.Context, requesterID int64, groupID int64, memberIDs []int64, lastUpdatedDate *time.Time)](../internal/domain/group/service/group_member_service.go#L681)
  ...
  - [x] `queryGroupManagersAndOwnerId(@NotNull Long groupId)` -> [QueryGroupManagersAndOwnerId(ctx context.Context, groupID int64)](../internal/domain/group/service/group_member_service.go#L674)
...
> [简述功能]
  ...
  - [x] `authAndCheckGroupQuestionAnswerAndJoin(@NotNull Long requesterId, @NotNull @ValidGroupQuestionIdAndAnswer Map<Long, String> questionIdToAnswer)` -> [CheckGroupJoinQuestionsAnswersAndJoin(ctx context.Context, requesterID int64, questionIdToAnswer map[int64]string)](../internal/domain/group/service/group_question_service.go#L130)
  - [x] `authAndCreateGroupJoinQuestions(@NotNull Long requesterId, @NotNull Long groupId, @NotNull List<NewGroupQuestion> questions)` -> [AuthAndCreateQuestion(ctx context.Context, requesterID int64, groupID int64, question string, answers []string, score int)](../internal/domain/group/service/group_question_service.go#L37)
  - [x] `createGroupJoinQuestions(@NotNull Long groupId, @NotNull List<NewGroupQuestion> questions)` -> [CreateJoinQuestion(ctx context.Context, groupID int64, question string, answers []string, score int)](../internal/domain/group/service/group_question_service.go#L116)
  - [ ] `queryGroupId(@NotNull Long questionId)`
  - [x] `authAndDeleteGroupJoinQuestions(@NotNull Long requesterId, @NotNull Long groupId, @NotNull Set<Long> questionIds)` -> [AuthAndDeleteQuestion(ctx context.Context, requesterID int64, groupID int64, questionID int64)](../internal/domain/group/service/group_question_service.go#L63)
  ...
  - [x] `authAndUpdateGroupJoinQuestion(@NotNull Long requesterId, @NotNull Long questionId, @Nullable String question, @Nullable Set<String> answers, @Nullable @Min(0)` -> [AuthAndUpdateQuestion(ctx context.Context, requesterID int64, groupID int64, questionID int64, question *string, answers []string, score *int)](../internal/domain/group/service/group_question_service.go#L80)
...
> [简述功能]
  ...
  - [x] `authAndDeleteGroup(boolean queryGroupMemberIds, @NotNull Long requesterId, @NotNull Long groupId)` -> [AuthAndDeleteGroup(ctx context.Context, requesterID int64, groupID int64)](../internal/domain/group/service/group_service.go#L251)
  - [x] `authAndCreateGroup(@NotNull Long creatorId, @NotNull Long ownerId, @Nullable String groupName, @Nullable String intro, @Nullable String announcement, @Nullable @Min(value = 0)` -> [AuthAndCreateGroup(ctx context.Context, creatorID, ownerID int64, name, intro *string, minimumScore *int32)](../internal/domain/group/service/group_service.go#L111)
  ...
  - [x] `queryGroupTypeIfActiveAndNotDeleted(@NotNull Long groupId)` -> [QueryGroupTypeIfActiveAndNotDeleted(ctx context.Context, groupID int64)](../internal/domain/group/service/group_service.go#L129)
  - [x] `queryGroupTypeIfActiveAndNotDeleted(@NotNull Long groupId, boolean preferCache)` -> [QueryGroupTypeIfActiveAndNotDeletedWithCache(ctx context.Context, groupID int64, preferCache bool)](../internal/domain/group/service/group_service.go#L141)
  - [x] `queryGroupTypeId(@NotNull Long groupId)` -> [QueryGroupTypeId(ctx context.Context, groupID int64)](../internal/domain/group/service/group_service.go#L113)
  ...
  - [x] `queryGroupMinimumScore(@NotNull Long groupId)` -> [QueryGroupMinimumScore(ctx context.Context, groupID int64)](../internal/domain/group/service/group_service.go#L154)
  - [x] `authAndTransferGroupOwnership(@NotNull Long requesterId, @NotNull Long groupId, @NotNull Long successorId, boolean quitAfterTransfer, @Nullable ClientSession session)` -> [AuthAndTransferGroupOwnership(ctx context.Context, requesterID, groupID, successorID int64, quitAfterTransfer bool, session mongo.SessionContext,)](../internal/domain/group/service/group_service.go#L173)
  - [x] `queryGroupOwnerId(@NotNull Long groupId)` -> [QueryGroupOwnerId(ctx context.Context, groupID int64)](../internal/domain/group/service/group_service.go#L124)
  - [x] `checkAndTransferGroupOwnership(@NotEmpty Set<Long> groupIds, @NotNull Long successorId, boolean quitAfterTransfer)` -> [CheckAndTransferGroupOwnership(ctx context.Context, groupIDs []int64, successorID int64, quitAfterTransfer bool)](../internal/domain/group/service/group_service.go#L191)
  - [x] `checkAndTransferGroupOwnership(@Nullable Long auxiliaryCurrentOwnerId, @NotNull Long groupId, @NotNull Long successorId, boolean quitAfterTransfer, @Nullable ClientSession session)` -> [CheckAndTransferGroupOwnershipWithSession(ctx context.Context, auxiliaryCurrentOwnerId *int64, groupID int64, successorID int64, quitAfterTransfer bool, session mongo.SessionContext)](../internal/domain/group/service/group_service.go#L202)
  - [x] `updateGroupInformation(@NotNull Long groupId, @Nullable Long typeId, @Nullable Long creatorId, @Nullable Long ownerId, @Nullable String name, @Nullable String intro, @Nullable String announcement, @Nullable @Min(0)` -> [UpdateGroupInformation(ctx context.Context, groupID int64, typeID *int64, creatorID *int64, ownerID *int64, name *string, intro *string, announcement *string, minimumScore *int32, isActive *bool)](../internal/domain/group/service/group_service.go#L407)
  - [x] `updateGroupsInformation(@NotNull Set<Long> groupIds, @Nullable Long typeId, @Nullable Long creatorId, @Nullable Long ownerId, @Nullable String name, @Nullable String intro, @Nullable String announcement, @Nullable @Min(0)` -> [UpdateGroupsInformation(ctx context.Context, groupIDs []int64, typeID *int64, creatorID *int64, ownerID *int64, name *string, intro *string, announcement *string, minimumScore *int32, isActive *bool)](../internal/domain/group/service/group_service.go#L422)
  - [x] `authAndUpdateGroupInformation(@NotNull Long requesterId, @NotNull Long groupId, @Nullable Long typeId, @Nullable Long creatorId, @Nullable Long ownerId, @Nullable String name, @Nullable String intro, @Nullable String announcement, @Nullable @Min(0)` -> [AuthAndUpdateGroup(ctx context.Context, requesterID int64, groupID int64, typeID *int64, successorID *int64, name *string, intro *string, announcement *string, minimumScore *int32, isActive *bool, quitAfterTransfer *bool)](../internal/domain/group/service/group_service.go#L246)
  - [x] `authAndQueryGroups(@Nullable Set<Long> groupIds, @Nullable String name, @Nullable Date lastUpdatedDate, @Nullable Integer skip, @Nullable Integer limit, @Nullable List<Integer> fieldsToHighlight)` -> [AuthAndQueryGroups(ctx context.Context, groupIDs []int64, name *string, lastUpdatedDate *time.Time, skip *int32, limit *int32, fieldsToHighlight []int32)](../internal/domain/group/service/group_service.go#L238)
  - [x] `queryJoinedGroups(@NotNull Long memberId)` -> [QueryJoinedGroups(ctx context.Context, memberID int64)](../internal/domain/group/service/group_service.go#L527)
  - [x] `queryJoinedGroupIdsWithVersion(@NotNull Long memberId, @Nullable Date lastUpdatedDate)` -> [QueryJoinedGroupIdsWithVersion(ctx context.Context, memberID int64, lastUpdatedDate *time.Time)](../internal/domain/group/service/group_service.go#L538)
  - [x] `queryJoinedGroupsWithVersion(@NotNull Long memberId, @Nullable Date lastUpdatedDate)` -> [QueryJoinedGroupsWithVersion(ctx context.Context, memberID int64, lastUpdatedDate *time.Time)](../internal/domain/group/service/group_service.go#L544)
  - [x] `isAllowedToCreateGroupAndHaveGroupType(@NotNull Long requesterId, @NotNull Long groupTypeId)` -> [IsAllowedToCreateGroupAndHaveGroupType(ctx context.Context, requesterID int64, groupTypeID int64)](../internal/domain/group/service/group_service.go#L551)
  - [x] `isAllowedToCreateGroup(@NotNull Long requesterId, @Nullable UserRole auxiliaryUserRole)` -> [IsAllowedToCreateGroup(ctx context.Context, requesterID int64)](../internal/domain/group/service/group_service.go#L370)
  - [x] `isAllowedCreateGroupWithGroupType(@NotNull Long requesterId, @NotNull Long groupTypeId, @Nullable UserRole auxiliaryUserRole)` -> [IsAllowedCreateGroupWithGroupType(ctx context.Context, requesterID int64, groupTypeID int64)](../internal/domain/group/service/group_service.go#L556)
  - [x] `isAllowedUpdateGroupToGroupType(@NotNull Long requesterId, @NotNull Long groupTypeId, @Nullable UserRole auxiliaryUserRole)` -> [IsAllowedUpdateGroupToGroupType(ctx context.Context, requesterID int64, groupTypeID int64)](../internal/domain/group/service/group_service.go#L561)
  ...
  - [x] `countCreatedGroups(@Nullable DateRange dateRange)` -> [CountCreatedGroups(ctx context.Context, dateRange *turmsmongo.DateRange)](../internal/domain/group/service/group_service.go#L567)
  ...
  - [x] `countDeletedGroups(@Nullable DateRange dateRange)` -> [CountDeletedGroups(ctx context.Context, dateRange *turmsmongo.DateRange)](../internal/domain/group/service/group_service.go#L572)
  - [x] `count()` -> [Count(ctx context.Context)](../internal/domain/group/repository/group_repository.go#L201)
  - [x] `isGroupMuted(@NotNull Long groupId)` -> [IsGroupMuted(ctx context.Context, groupID int64)](../internal/domain/group/service/group_service.go#L494)
  - [x] `isGroupActiveAndNotDeleted(@NotNull Long groupId)` -> [IsGroupActiveAndNotDeleted(ctx context.Context, groupID int64)](../internal/domain/group/service/group_service.go#L509)
...
> [简述功能]
  ...
  - [x] `initGroupTypes()` -> [InitGroupTypes(ctx context.Context)](../internal/domain/group/service/group_type_service.go#L47)
  - [x] `queryGroupTypes(@Nullable Integer page, @Nullable Integer size)` -> [QueryGroupTypes(ctx context.Context, page, size *int32)](../internal/domain/group/service/group_type_service.go#L76)
  - [x] `addGroupType(@Nullable Long id, @NotNull @NoWhitespace String name, @NotNull @Min(1)` -> [AddGroupType(ctx context.Context, groupType *po.GroupType)](../internal/domain/group/service/group_type_service.go#L52)
  - [x] `updateGroupTypes(@NotEmpty Set<Long> ids, @Nullable @NoWhitespace String name, @Nullable @Min(1)` -> [UpdateGroupTypes(ctx context.Context, ids []int64, update *po.GroupType)](../internal/domain/group/service/group_type_service.go#L57)
  - [x] `deleteGroupTypes(@Nullable Set<Long> groupTypeIds)` -> [DeleteGroupTypes(ctx context.Context, groupTypeIds []int64)](../internal/domain/group/service/group_type_service.go#L62)
  - [x] `queryGroupType(@NotNull Long groupTypeId)` -> [QueryGroupType(ctx context.Context, groupTypeID int64)](../internal/domain/group/service/group_type_service.go#L67)
  - [x] `queryGroupTypes(@NotNull Collection<Long> groupTypeIds)` -> [QueryGroupTypesByIds(ctx context.Context, groupTypeIds []int64)](../internal/domain/group/service/group_type_service.go#L81)
  - [x] `groupTypeExists(@NotNull Long groupTypeId)` -> [GroupTypeExists(ctx context.Context, groupTypeID int64)](../internal/domain/group/service/group_type_service.go#L86)
  - [x] `countGroupTypes()` -> [CountGroupTypes(ctx context.Context)](../internal/domain/group/service/group_type_service.go#L91)
...
> [简述功能]
  ...
  - [x] `queryGroupJoinRequestsVersion(@NotNull Long groupId)` -> [QueryGroupJoinRequestsVersion(ctx context.Context, groupID int64)](../internal/domain/group/service/group_version_service.go#L58)
  ...
  - [x] `updateGroupInvitationsVersion(@NotNull Long groupId)` -> [UpdateInvitationsVersion(ctx context.Context, groupID int64)](../internal/domain/group/service/group_version_service.go#L36)
  ...
  - [x] `upsert(@NotNull Long groupId, @NotNull Date timestamp)` -> [Upsert(ctx context.Context, groupID int64, timestamp time.Time)](../internal/domain/group/service/group_version_service.go#L94)
  - [x] `delete(@Nullable Set<Long> groupIds, @Nullable ClientSession session)` -> [Delete(ctx context.Context, groupIDs []int64)](../internal/domain/group/service/group_version_service.go#L99)
